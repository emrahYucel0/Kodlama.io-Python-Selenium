...
class Test_Demo:
    ...
    def test_buyProduct(self,firstname,lastname,postalcode):
        ...
        # actions.click(addChartButton)
        # actions.click(shoppingCart)
        # sleep(10)
        # actions.click(checkout_button)
        # sleep(2)
        # actions.send_keys_to_element(firstNameInput,"Emrah")
        # actions.send_keys_to_element(lastNameInput, "Yücel")
        # actions.send_keys_to_element(postalCodeInput,"3434")
